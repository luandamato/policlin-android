package br.com.policlinsaude.ui.legacy.notHasPassword.presenter
...
class NotHasPasswordPresenterImpl(private val navigator: NotHasPasswordNavigator,
    ...
    override fun checkPlan(presentationPlan: PresentationPlan, callback: StepperLayout.OnNextClickedCallback?) {
